...
namespace ConcaveHull
{
    public static class Hull
    {
        ...
        public static List<List<Line>> hull_edges = new List<List<Line>>();
        public static List<List<Node>> hull_nodes = new List<List<Node>>();
        ...
        public static void setConvHull(List<Node> nodes)
        {
            ...
            // hull_edges.AddRange(getHull(nodes)); // get surrounding lines
            ...
            List<Line> curr_edges = getHull(nodes);
            hull_edges.Add(curr_edges);
        }
